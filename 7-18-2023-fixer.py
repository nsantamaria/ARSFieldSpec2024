...
def adjust_second_digit(column_name):
    return re.sub(r'^(.)(2|3)', lambda x: x.group(1) + ('3' if x.group(2) == '2' else '5'), column_name)
...
df_2023_1.to_csv('/Users/niks/Desktop/USDA/Spring 2024/Data/2023 NxIrr_hyperspectral_txt/7-18-2023(fixed).csv', index=False)
